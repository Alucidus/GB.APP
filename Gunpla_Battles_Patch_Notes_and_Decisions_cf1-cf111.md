...
---
Historical patch archive (through cf110)

# Gunpla Battles — Complete Patch Notes & Decision Log

**Current build: cf110**  
**Scope:** every recorded Cloudflare release, cf1–cf110; detailed notes for cf100–cf110; the current engagement decisions; and the full supplied development archive, including older v-series and mp-series records.

The latest deployable application is **gunpla-battle-cf-cf110.zip**.
...
## cf109 — Equipment/stow UX and melee decisions

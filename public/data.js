...
TABLES['Funnels / d6 Dice Pool']=[['d6 result','Eligible range'],['1','Miss'],['2','Under 30cm'],['3','Under 30cm or 30–60cm'],['4','Out to 90cm'],['5–6','Out to 120cm'],['Weapon limit','Never exceed the weapon’s range. Standard Funnels: 60cm.'],['Pool','Roll all dice before choosing targets. One die per potential target, up to the ability maximum.'],['Stacking','Assign eligible dice freely; stacked dice form one attack, with one Dodge/Block reaction for the whole stack.'],['Damage','Per-die damage × successful dice in the stack, applied to one normally rolled hit location.']];
const UNITS=[
 {
  "id": "gm-rgm-79-origin",

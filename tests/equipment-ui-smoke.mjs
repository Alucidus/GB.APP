...
for(const name of ['supplies','resupply-ui','data','equipment','equipment-ui','app'])vm.runInContext(fs.readFileSync(new URL('../public/'+name+'.js',import.meta.url),'utf8'),ctx,{filename:name+'.js'});
